...
$db_handle = new myFunctions();
  ...
  if($search != NULL && $num_rows!= NULL){
    $results = $db_handle->getUsers($search,$num_rows);
  }
  if ($num_rows !=NULL && $search == NULL) {
    $results = $db_handle->getUsers("",$num_rows);
  }
?>
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                ...
                                <div class="pull-right" ><a href="add_new_user.php" style="margin-bottom:8px; margin-top:-5px;" class="btn btn-xs btn-info">Add New User</a></div>
                            </div>
                               ...
                               <center>
                                   ...
                                   <table style="margin-top:-15px"; class="table table-bordered table-stripted table-hover">
                                      <thead>
                                       ...
                                       <tr>
                                            <td><?php echo ++$i; ?></td>
                                            <td><?php echo htmlentities($user["userFullName"]); ?></td>
                                            <td><?php echo htmlentities($user["userType"]); ?></td>
                                            <td><?php echo htmlentities($user["userEmail"]); ?></td>
                                            <td><?php echo htmlentities($user["userPhone"]); ?></td>
                                           <td align="center">
                                              <center>
                                                <a style="text-decoration:none;color:green;" href="details_user.php?id=<?php echo $user['userid']; ?>"  rel="facebox" >Details</a>
                                                <a style="text-decoration:none;color:blue;"   href="edit_user.php?id=<?php echo $user['userid']; ?>">Edit</a>
                                                <?php if(htmlentities($user["userTypeId"])!="1"){ ?>
                                                <a style="text-decoration:none;color:red;" onClick="return confirm('Do you want to Delete this User?');"   href="delete_user.php?id=<?php echo $user['userid']; ?>&&image=<?php echo htmlentities($user["userImage"]); ?>">Delete</a>
                                              <?php } ?>
                                              </center>
                                            </td>
                                       </tr>
                                    ...
                                    <?php 
                                    echo "Showing <b>".$i."</b> Rows of <b>".$db_handle->getTotalRowNumber("tbusers")."</b> Rows";
