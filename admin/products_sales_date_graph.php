                    ...
                    <div class="row-fluid">
                        ...
                        <div class="block span12">
                            ...
                            <div class="block-content collapse in">
                                ...
                                <input type="text" name="cdate" required style="margin-top:10px;" placeholder="Select Date" > &nbsp;&nbsp;
                                <input name="show_report" type="submit" class="btn btn-success"  value="Show Graph"> 
                               </form> 
                            </div>
                        </div>
                        <!-- /block -->
