                              ...
                              <br>
                                <table style="margin-top:-15px"; class="table table-bordered table-stripted table-hover">
                                      <thead style="font-size:15px;color:black;">
                                            <th width="">Shopping Date<br></th>
                                       </thead>
                                    <?php
                                         $search = $_GET['cphone'];
                                         $results = $db_handle->searchCustomerShoppingDate($search);
                                        ...
                                        ?>
                                       <tr>
                                            <td><a href="customer_date_wise_invoice_list.php?cdate=<?php echo htmlentities($date["invoiceDate"]);?>&&cphone=<?php echo $search;?>"><?php echo htmlentities($date["invoiceDate"]); ?></a>
                                            </td>
                                        </tr>
