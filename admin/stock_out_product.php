...
$db_handle = new myFunctions();
  ...
  if($search != NULL && $num_rows!= NULL){
    $results = $db_handle->getProductInventory($search,$num_rows," quantity <= 0");
  }
  if ($num_rows !=NULL && $search == NULL) {
    $results = $db_handle->getProductInventory("",$num_rows," quantity <= 0");
  }
?>
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left" >Stock Out Products List</div>
                                   ...
                                   <table style="margin-top:-15px"; class="table table-bordered table-stripted table-hover">
                                      <thead>
                                       ...
                                       <tr>
                                            ...
                                            <td style="font-weight:bold;color:red;"><?php echo htmlentities($product["quantity"])." ".htmlentities($product["unitName"]); ?></td>
