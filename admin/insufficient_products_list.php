...
$db_handle = new myFunctions();
  ...
  if($search != NULL && $num_rows!= NULL){
    $results = $db_handle->getProductInventory($search,$num_rows," quantity < 10 ");
  }
  if ($num_rows !=NULL && $search == NULL) {
    $results = $db_handle->getProductInventory("",$num_rows," quantity < 10 ");
  }
?>
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left" >Insufficient Products List</div>
                                <div class="pull-right" ><a href="manage_products.php" style="margin-bottom:8px; margin-top:-5px;" class="btn btn-xs btn-primary">Manage Product</a></div>
                            </div>
                                   ...
                                   <table style="margin-top:-15px"; class="table table-bordered table-stripted table-hover">
                                      <thead>
                                       ...
                                       <tr>
                                            ...
                                            <td style="font-weight:bold; color:#682626;"><?php echo htmlentities($product["quantity"])." ".htmlentities($product["unitName"]); ?></td>
