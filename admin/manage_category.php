...
$db_handle = new myFunctions();
  ...
  if($search != NULL && $num_rows!= NULL){
    $results = $db_handle->getCategory($search,$num_rows);
  }
  if ($num_rows !=NULL && $search == NULL) {
    $results = $db_handle->getCategory("",$num_rows);
  }
?>
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                ...
                                <div class="pull-right" ><a href="add_category.php" style="margin-bottom:8px; margin-top:-5px;" class="btn btn-xs btn-info">Add New Category</a> &nbsp; <a href="manage_references.php" style="margin-bottom:8px; margin-top:-5px;" class="btn btn-xs btn-primary">Raferences</a></div>
                            </div>
                               ...
                               <center>
                                   ...
                                   <table style="margin-top:-15px"; class="table table-bordered table-stripted table-hover">
                                      <thead>
                                       ...
                                       <tr>
                                            <td><?php echo ++$i; ?></td>
                                            <td><?php echo htmlentities($category["cname"]); ?></td>
                                            <td>
                                                <a style="text-decoration:none;color:red;" onClick="return confirm('Do you want to Delete this Category?');"   href="delete_category.php?id=<?php echo $category['cid']; ?>">Delete</a>
                                            </td>
                                       </tr>
                                       <?php 
                                    ...
                                    <?php 
                                    echo "Showing <b>".$i."</b> Rows of <b>".$db_handle->getTotalRowNumber("tbcategory")."</b> Rows";
