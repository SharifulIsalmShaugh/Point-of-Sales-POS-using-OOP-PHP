                    ...
                    <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left" >Add New Product Category</div>
                                <div class="pull-right" ><a href="manage_category.php" style="margin-bottom:8px; margin-top:-5px;" class="btn btn-xs btn-primary">Manage Category</a></div>
                            </div>
                            <div class="block-content collapse in">
                               ...
                               <?php if (isset($_POST['save'])) {
                               	...
                               	$r = $db_handle->saveCategory($name);

                               	if($r==1){
                               			echo "<h2 style='color:green;'>Categotry has been Successfully Inserted</h2>";

                               			echo "<br />";

                               			echo "<a href='add_category.php' style='margin-bottom:8px; margin-top:-5px;'' class='btn btn-xs btn-success'>Add Another Category</a> &nbsp;&nbsp;";

                               			echo "<a href='manage_category.php' style='margin-bottom:8px; margin-top:-5px;'' class='btn btn-xs btn-primary'>Manage Category</a>";
                               	}else{
                               			...
                               			echo "<a href='add_category.php' style='margin-bottom:8px; margin-top:-5px;'' class='btn btn-xs btn-primary'>Try Again</a> &nbsp;&nbsp;";
                               		}
                                   ...
                                   <form action="" method="POST">
	                                      <table width="450px;">
	                                      	...
	                                      	<tr> <td> Category Name:</td><td> <input name="name"  style=" margin-top:10px;"  required  type="text" placeholder="Insert Category name"></td></tr>
