...
class PDF extends FPDF
{
	function Header()
	{
		...
		$this->Cell(200,10,"Tech Novelty Solution Ltd.",0,0,'C');
		$this->Ln(6);

		$this ->SetFont('Times','',11);;
		$this->Cell(200,10,"House: 20, Road:2/B , Sector:Uttara 11",0,0,'C');
		$this->Ln(5);

		$this ->SetFont('Times','',11);;
		$this->Cell(200,10,"Phone: 01824168996 ,01672331428",0,0,'C');
		$this->Ln(5);

		$this ->SetFont('Times','',11);;
		$this->Cell(200,10,"Email: info@tech-novelty.com",0,0,'C');
		$this->Ln(9);
	}
